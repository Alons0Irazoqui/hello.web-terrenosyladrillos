...
(function () {
  ...
  Dot.prototype.draw = function () {
    ...
    if (this.r > 1.0) {
      ...
      grd.addColorStop(0, 'rgba(212,175,55,' + (this.a * .7) + ')');
...
/* ═══════════════════════════════
   ...
   ═══════════════════════════════ */
(function () {
  var words = ['Patrimonio', 'Utilidad', 'Rentabilidad', 'Legado'];
  var idx   = 0;
...
document.getElementById('cForm').addEventListener('submit', function (e) {
  ...
  var txt = '*Solicitud de Evaluación — Terrenos y Ladrillos*\n\n';
  txt += '• Nombre: '    + nombre  + '\n';
  if (empresa) txt += '• Empresa: ' + empresa + '\n';
  txt += '• Teléfono: '  + tel     + '\n';
  if (email)   txt += '• Correo: '  + email   + '\n';
  txt += '• Tipo de solicitud: ' + tipo    + '\n';
  txt += '• Detalles: '      + mensaje;

  window.open('https://wa.me/523334896901?text=' + encodeURIComponent(txt), '_blank');
});
